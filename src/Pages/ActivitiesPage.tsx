...
import { Activities, Bcoin, Earn, LuckyWin, memeCoin, mine, Ref1, rightArrow, telegarmicon, usercomments, Wallet, xicon, youtubeicon } from '../images';
...
const ActivitiesPage: React.FC = () => {
  ...
  return (
    ...
    {/* only open when videos for yt is avaliable */}
